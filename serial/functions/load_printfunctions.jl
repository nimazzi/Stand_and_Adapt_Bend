...
function print0(b::B3_type)
    
    println(" ")
    println(" */"*"-"^ 32*"/*")
    println(" algorithm          : " * "zaker_bend")
    println(" case               : $(b.data.case)")
    println(" σ value            : $(round(b.data.q;digits=1))")
    println(" investment  nodes  : $(b.data.ms.I0[end])")
    println(" operational nodes  : $(b.data.ms.I[end])")
    println(" */"*"-"^ 32*"/*")
...
function print0(b::B2_type)
    ...
    println(" case               : $(b.data.case)")
    println(" subs per iter      : $(b.data.w)")
    println(" investment  nodes  : $(b.data.ms.I0[end])")
    println(" operational nodes  : $(b.data.ms.I[end])")
    println(" */"*"-"^ 32*"/*")
